    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Create and manage assignments for assigned classes and subjects.
        </p>
      </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Create an assignment linked to a teacher, subject, class, session,
          and term.
        </p>
