...
import AssessmentForm from "../assessments/assessment-form";
  ...
  if (
    ...
    return (
      <div className="rounded-xl border border-red-200 bg-red-50 p-6 text-red-700">
        You do not have permission to access tests.
      </div>
    );
  }
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Create and manage tests for assigned classes and subjects.
        </p>
      </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Create a test linked to a teacher, subject, class, session, and
          term.
        </p>
